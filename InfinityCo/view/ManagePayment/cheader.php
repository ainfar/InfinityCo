...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="justify-content: center; padding: 0px; background-color: #808080; color:white;">
  <ul class="navbar-nav">
    <li class="nav-item active ">
      <a class="nav-link" href="chome_interface.php" style="color:white">Home</a>
    </li>
    ...
    <li class="nav-item active ">
      <a class="nav-link" href="cfeedback_interface.php" style="color:white">Feedback</a>
    </li>

    <li class="nav-item active ">
      <a class="nav-link" href="Question_Page" style="color:white">Post Question</a>
    </li>
