...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="justify-content: center; padding: 0px; background-color: #808080; color:white;">
  <ul class="navbar-nav">
    <li class="nav-item active ">
      <a class="nav-link" href="../ManageSupplier/shome_interface.php" style="color:white">Home</a>
    </li>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="payment">
        <a class="dropdown-item" href="../ManageEvent/S_View_Event_Page.php">Event</a>
        <a class="dropdown-item" href="../Manage_Equipment/S_EqHomepage_Interface.php">Equipment</a>
      </div>
    </li>

    <li class="nav-item active ">
      <a class="nav-link" href="../ManageSupplier/sprogress_interface.php" style="color:white">Progress</a>
    </li>

    <li class="nav-item active ">
      <a class="nav-link" href="../ManageSupplier/sfeedback_interface.php" style="color:white">Feedback</a>
    </li>
