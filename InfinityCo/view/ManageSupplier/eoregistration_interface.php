            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        <h2 class="form-title">Create Event Organizer Account</h2>
                        ...
                        <div class="form-group">
                        <input type="text" class="form-input" name="Company" id="Company" placeholder="Your Company Number"/>
                        </div>
                    ...
                    <p class="loginhere">
                        Have already an account ? <a href="eologin_interface.php" class="loginhere-link">Login here</a>
                    </p>
