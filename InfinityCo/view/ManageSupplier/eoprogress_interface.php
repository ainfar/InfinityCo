...
<head>
    <!-- Title -->
    <title>Event Organizer Update Progress Event</title>
...
<body>
    ...
    <div class="col-20 col-md-20 col-lg-20">
        ...
        <a href='eoprogdetails_interface.php' class='btn btn-primary m-b-1em'>List Testing Attendance</a><br><br>
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="">
                        ...
                        <input type="submit" name="btnDetail" class="btn btn-danger" formaction="./eoattendform_interface.php" value="DETAIL">
                    </form>  
                </td>
            </tr>
