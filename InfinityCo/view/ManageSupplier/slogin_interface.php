        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
						...
						<div>
                         Account Type: <br>
                          <input type="radio" name="Account_Type" value="Customer"> Customer <br>
   						 ...
   						 <input type="radio" name="Account_Type" value="Supplier" checked> Supplier <br>
                        </div>
						<br>
                    ...
                    <p class="Register">
                        Create New Account ? <a href="sregistration_interface.php" class="Register-link">Register</a>
                    </p>
                    <p class="Register">
                        Forget Password ? <a href="sforgetpass_interface.php" class="Register-link">Reset</a>
                    </p>
                </div>
            </div>
        </section>
