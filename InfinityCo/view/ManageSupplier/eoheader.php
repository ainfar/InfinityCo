...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="justify-content: center; padding: 0px; background-color: #808080; color:white;">
  <ul class="navbar-nav">
    <li class="nav-item active ">
      <a class="nav-link" href="../ManageSupplier/eohome_interface.php" style="color:white">Home</a>
    </li>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="payment">
        <a class="dropdown-item" href="../ManageEvent/Booking_List_Page.php">Booking List</a>
      </div>
    </li>

    <li class="nav-item active ">
      <a class="nav-link" href="../ManageSupplier/eoprogress_interface.php" style="color:white">Progress</a>
    </li>

    <li class="nav-item active ">
      <a class="nav-link" href="../ManageSupplier/eofeedback_interface.php" style="color:white">Feeback</a>
    </li>

    <li class="nav-item active ">
      <a class="nav-link" href="../ManageEvent/Question_Page.php" style="color:white">Post Question</a>
    </li>
