...
include ($_SERVER["DOCUMENT_ROOT"]."../InfinityCo/controller/SupplierController/eofeedbackController.php");

if (isset($_POST['submit'])) {
    // create controller
    $feedback = new eofeedbackController();
    // call method dd
        $feedback->feedback();
}
?>
...
<head>
    <!-- Title -->
    <title>Event Organizer Feedback Form</title>
...
<body>
    ...
    <center><b><h1 style="color:black; font-size:45px;">Event Organizer Feedback</h1></b></center>
    ...
    <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="radio" name="feedback" value="Event Organizer" checked="" >Event Organizer<br> 
                <input type="radio" name="feedback" value="Customer" >Customer
            </div>
