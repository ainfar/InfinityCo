...
class account
{
	...
	public function save()
	{
		...
		$query = "INSERT INTO register (Name, Password, Username, Email, Address, ContactNo, ICno, Account_Type, Gender) VALUES (:Name, :Password, :Username, :Email, :Address, :ContactNo, :ICno, :Account_Type, :Gender)";
	...
	public function S_save()
	{
		...
		$query = "INSERT INTO register (Name, Password, Username, Email, Address, ContactNo, ICno, Account_Type, Company, Gender) VALUES (:Name, :Password, :Username, :Email, :Address, :ContactNo, :ICno, :Account_Type, :Company, :Gender)";
